...
const AsideNabar = () => {
  ...
  const links = [
    {
      ...
      icon: (
        ...
        >
          <path
            d="M8.42229 20.618C10.1779 21.5393 11.0557 22 12 22V12L2.63802 7.07264C2.62423 7.09479 2.6107 7.11716 2.5974 7.13974C2 8.15425 2 9.41667 2 11.9415V12.0585C2 14.5833 2 15.8458 2.5974 16.8603C3.19479 17.8748 4.27063 18.4393 6.42229 19.5685L8.42229 20.618Z"
            fill="currentColor"
          ></path>{" "}
          <path
            opacity="0.5"
      ...
      icondown: (
        <svg
          className={`ms-4 text-[29px] text-center  accordion-icon transition-transform duration-300  ${
            toggleState.item1 ? "transform rotate-180" : ""
          }`}
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
...

    {
      ...
      icondown: (
        <svg
          className={`ms-4 text-[29px] text-center  accordion-icon transition-transform duration-300  ${
            toggleState.item2 ? "transform rotate-180" : ""
          }`}
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
...

    {
      ...
      icondown: (
        <svg
          className={`ms-4 text-[29px] text-center  accordion-icon transition-transform duration-300  ${
            toggleState.item6 ? "transform rotate-180" : ""
          }`}
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
...

    {
      ...
      icondown: (
        <svg
          className={`ms-4 text-[29px] text-center  accordion-icon transition-transform duration-300  ${
            toggleState.item7 ? "transform rotate-180" : ""
          }`}
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
...

    {
      ...
      icondown: (
        <svg
          className={`ms-4 text-[29px] text-center  accordion-icon transition-transform duration-300  ${
            toggleState.item8 ? "transform rotate-180" : ""
          }`}
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
...

    {
      ...
      icondown: (
        <svg
          className={`ms-4 text-[29px] text-center  accordion-icon transition-transform duration-300  ${
            toggleState.item9 ? "transform rotate-180" : ""
          }`}
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
...

    {
      ...
      icondown: (
        <svg
          className={`ms-4 text-[29px] text-center  accordion-icon transition-transform duration-300  ${
            toggleState.item10 ? "transform rotate-180" : ""
          }`}
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
  ...
  return (
    <section>
      ...
      <ul className="flex text-[#787878fa]">
        <li
          className={` transition-transform duration-300  p-3 mx-[20px]   ${
            toggleState.item2 ? "active" : ""
          }`}
        >
          {links.map((link) => (
            <div key={link.id} onClick={link.onClick} className="  w-[100%]">
              <div className="flex px-2 w-[200px] py-4 rounded-[10px] hover:bg-[#08182F]  hover:fill-currentn  hover:text-[#4d25ec]">
                <span>{link.icon}</span>
                <span className="ms-3 flex w-[100%] ">{link.title}</span>
                <span className="text-end  ms-3  justify-end me-0 ">
                  {link.icondown}
                </span>
              </div>
              {toggleState["item" + link.id] && (
                <li className="w-[140px]  ">
                  {link.submenu.map((val) => (
                    <Link
                      key={val.id}
                      href={val.url}
                      className="flex mt-2 ms-3 hover:fill-currentn  hover:text-[#4d25ec]"
                    >
                      {val.title}
                    </Link>
                  ))}
